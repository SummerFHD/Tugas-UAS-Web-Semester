		...
		<div class="col-lg-12 m-auto p-3 mt-4">
			<div class="bg-white p-5 position-relative shadow-xl rounded-1">
				...
				<form method="POST" action="{{ route('create.store') }}" enctype="multipart/form-data">
					@csrf
					<div class="group"> 
						<input class="inputMaterial" name="jenis" type="text" value="{{ old('jenis') }}" required>   
						<span class="bar"></span>
					...
					<div class="group"> 
						<input class="inputMaterial" name="deskripsi" type="text" value="{{ old('deskripsi') }}" required>   
						<span class="bar"></span>
