  ...
  <body style="background: #EEEEEE;">
		<div class="col-lg-12 m-auto p-3 mt-4">
			<div class="bg-white p-5 position-relative shadow-xl rounded-1">
				...
				<form method="POST" action="<?php echo e(route('edit.store', $product->id)); ?>" enctype="multipart/form-data">
					<?php echo csrf_field(); ?>
					<?php echo method_field('PUT'); ?>
					<div class="group"> 
						<input class="inputMaterial" name="jenis" type="text" value="<?php echo e($product->jenis); ?>" required>   
						<span class="bar"></span>
					...
					<div class="group"> 
						<input class="inputMaterial" name="deskripsi" type="text" value="<?php echo e($product->deskripsi); ?>" required>   
						<span class="bar"></span>
					...
					<div class="group"> 
						...
						<div class="form-text"><?php echo e($product->gambar); ?></div>
					</div>
...
</html><?php /**PATH C:\Users\ASUS\Documents\backup\!WORK\tugas_andi\resources\views/dashboard/edit.blade.php ENDPATH**/ ?>